...
public class LoginActivity extends Activity implements View.OnClickListener, LoginView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveLoginData.setId(id);
        saveLoginData.setUserSig(userSig);
        saveLoginData.setToken(token);
        MySelfInfo.getInstance().getCacheTest(getApplicationContext(), saveLoginData);
