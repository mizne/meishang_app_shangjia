...
export class QuillEditorWrapperComponent
  ...
  @Input() videoCancelSubject: Subject<void> = new Subject<void>();

  @Output() videoPercent: EventEmitter<number> = new EventEmitter<number>();
  ...
  videoHandler() {
    ...
    videoInput.addEventListener('change', () => {
      ...
      .pipe(
        takeUntil(this.videoCancelSubject.asObservable())
      ).subscribe(
        loc => {
          if (typeof loc === 'string') {
            this.loading = false;
